...
import com.example.weatherapp.databinding.WFwidgetConfigureBinding;
...
public class AppWidgetConfigurationActivity extends AppCompatActivity {
    ...
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            final Context context = AppWidgetConfigurationActivity.this;
    ...
    public void onCreate(Bundle icicle) {
        ...
        binding = WFwidgetConfigureBinding.inflate(getLayoutInflater());
        ...
        mAppWidgetText.setText(loadTitlePref(AppWidgetConfigurationActivity.this, mAppWidgetId));
    }
}
